...
namespace std {
template<typename... Args>
struct tuple_element<0, Upp::Tuple<Args...>> {
	using type = typename Upp::Tuple<Args...>::T1;
};

template<typename... Args>
struct tuple_element<1, Upp::Tuple<Args...>> {
	using type = typename Upp::Tuple<Args...>::T2;
};

template<typename... Args>
struct tuple_element<2, Upp::Tuple<Args...>> {
	using type = typename Upp::Tuple<Args...>::T3;
};

template<typename... Args>
struct tuple_element<3, Upp::Tuple<Args...>> {
	using type = typename Upp::Tuple<Args...>::T4;
};

template<typename... Args>
struct tuple_size<Upp::Tuple<Args...>> {
