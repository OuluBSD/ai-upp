...
synth = input_net.AddAtom("synth0", "fmsynth.pipe", {"filepath": "presets/fmsynth/presets/old_school_organ.fmp", "verbose": False})
...
router.BuildRouterChain([event, input_net], "02e linked")