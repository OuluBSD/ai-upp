...
public:
	...
	virtual Node& operator[] (int i) { throw Exc("Node::operator[] not implemented"); }
...
public:
	...
	virtual Node& operator[] (int i) {if (i == 0) return *formula; throw Exc("Index error");}
...
public:
	...
	virtual Node& operator[] (int i) {if (i == 0) return *formula_a; if (i == 1) return *formula_b; throw Exc("Index error");}
...
public:
	...
	virtual int GetCount() const {return 2;}
	virtual Node& operator[] (int i) {if (i == 0) return *variable; if (i == 1) return *formula; throw Exc("Index error");}
