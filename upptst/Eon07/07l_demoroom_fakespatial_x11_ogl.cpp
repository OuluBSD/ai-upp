...
void Run07lDemoroomFakespatialX11Ogl(Engine& eng, int method) {
	...
	case 1:
	case 2:
		LOG(Format("warning: Run07lDemoroomFakespatialX11Ogl: method %d not implemented yet", method));
	case 0:
		sys->PostLoadFile(ShareDirFile("eon/tests/07l_demoroom_fakespatial_x11_ogl.eon"));
		break;
	default:
		throw Exc(Format("Run07lDemoroomFakespatialX11Ogl: unknown method %d", method));
	}
}
