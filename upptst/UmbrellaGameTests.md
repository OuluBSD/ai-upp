...
**Features tested**:
- Level loading and saving functionality
...
**Features tested**:
- Sound loading with different types (SFX, MUSIC, VOICE)
...
The tests verify basic functionality of the components and ensure they can be integrated into the broader Umbrella game system.