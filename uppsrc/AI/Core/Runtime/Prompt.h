#ifndef _AI_Core_Runtime_Prompt_h_
#define _AI_Core_Runtime_Prompt_h_
...
struct TaskTitledList {
	...
	TaskTitledList& Title(String title_fmt, String value = String())
	{
		title_format_str = title_fmt;
		title_value = value;
		return *this;
	}
	TaskTitledList& FormatArg(String s)
	{
		title_args << s;
		return *this;
	}
	TaskTitledList& Add(String s)
	{
		values.Add(s);
		return *this;
	}
	TaskTitledList& Add(String key, String value)
	{
		items.Add(key, value);
		return *this;
	}
	TaskTitledList& Add(String key, int value)
	{
		items.Add(key, IntStr(value));
		return *this;
	}
	TaskTitledList& NoColon(bool b = true)
	{
		no_colon = b;
		return *this;
	}
	TaskTitledList& NoListChar(bool b = true)
	{
		no_listchar = b;
		return *this;
	}
	TaskTitledList& TitleInQuotes(bool b = true)
	{
		title_in_quotes = b;
		return *this;
	}
	TaskTitledList& ValueInQuotes(bool b = true)
	{
		value_in_quotes = b;
		return *this;
	}
	TaskTitledList& CountSub(bool b = true)
	{
		count_sub = b;
		return *this;
	}
	TaskTitledList& CountLines(bool b = true)
	{
		count_lines = b;
		return *this;
	}
	TaskTitledList& CountLinesAlpha(bool b = true)
	{
		line_in_alpha = true;
		count_lines = b;
		return *this;
	}
	TaskTitledList& CountLines(String line_str, bool b = true)
	{
		this->line_str = line_str;
		count_lines = b;
		return *this;
	}
	TaskTitledList& InlineList(bool b = true)
	{
		inline_list = b;
		return *this;
	}
	TaskTitledList& NoSeparator(bool b = true)
	{
		no_separator = b;
		return *this;
	}
	TaskTitledList& CombinationString(bool b = true)
	{
		combination_string = b;
		return *this;
	}
	TaskTitledList& EmptyLine(bool b = true)
	{
		empty_line = b;
		return *this;
	}
	TaskTitledList& Capitalize(bool b = true)
	{
		capitalize = b;
		return *this;
	}
	TaskTitledList& AddSub() { return sub.Add(); }
	TaskTitledList& Arg(String s)
	{
		args.Add(s);
		return *this;
	}
	TaskTitledList& Separator(String s)
	{
		separator = s;
		return *this;
	}
	TaskTitledList& LineBegin(int line_begin)
	{
		this->line_begin = line_begin;
		return *this;
	}
	TaskTitledList& NumberedLines(bool b = true)
	{
		numbered_lines = b;
		return *this;
	}
	TaskTitledList& NoNumberedLinesSpace(bool b = true)
	{
		no_numbered_lines_space = b;
		return *this;
	}
	TaskTitledList& EmptyLineString(String s)
	{
		empty_line_string = s;
		return *this;
	}
