...
// Additional keys needed by CtrlKbd.cpp
K_PLUS           = SDLK_EQUALS + K_DELTA,
K_MINUS          = SDLK_MINUS + K_DELTA,
K_COMMA          = SDLK_COMMA + K_DELTA,
K_PERIOD         = SDLK_PERIOD + K_DELTA,
K_SEMICOLON      = SDLK_SEMICOLON + K_DELTA,
K_SLASH          = SDLK_SLASH + K_DELTA,
K_GRAVE          = SDLK_BACKQUOTE + K_DELTA,
K_LBRACKET       = SDLK_LEFTBRACKET + K_DELTA,
K_BACKSLASH      = SDLK_BACKSLASH + K_DELTA,
K_RBRACKET       = SDLK_RIGHTBRACKET + K_DELTA,
K_QUOTEDBL       = SDLK_QUOTE + K_DELTA,
