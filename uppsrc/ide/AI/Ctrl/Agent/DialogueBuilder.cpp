...
bool DialogueBuilder::BuildPackage(const String& package, Vector<String>& linkfile, Vector<String>&, String& linkoptions,
...
bool DialogueBuilder::Preprocess(const String& package, const String& file, const String& target, bool)
{
	return Builder::Preprocess(file, target, Null, false);
}

bool DialogueBuilder::PreprocessJava(String file, String target, String options,
                                 String package, const Package& pkg)
{
	...
	return !error;*/TODO return false;
}

Time DialogueBuilder::AddClassDeep(String& link, String dir, String reldir)
{
	/*Time time = Time::Low();
...
bool DialogueBuilder::Link(const Vector<String>& linkfile, const String& linkoptions, bool)
{
...
static Builder *CreateDialogueBuilder()
{
	return new DialogueBuilder;
}

INITIALIZER(DialogueBuilder)
{
	RegisterBuilder("DIALOGUE", &CreateDialogueBuilder);
}
