...
public:
	...
	static void ReadLLDBValues(CParser& p, VectorMap<String, String>& val);
	static void ReadLLDBValues(const String& h, VectorMap<String, String>& val);
