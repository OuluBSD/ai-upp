...
const TestCase kTests[] = {
	{ Run04aSdlAudio, "Run04aSdlAudio" },
	{ Run04bSdlVideo, "Run04bSdlVideo" },
	{ Run04cSdlVideoOgl, "Run04cSdlVideoOgl" },
	{ Run04dSdlVideoOglCustom, "Run04dSdlVideoOglCustom" },
	{ Run04eSdlVideoOglCustomLinked, "Run04eSdlVideoOglCustomLinked" },
	{ Run04fSdlVideoOglCustomLinkedSide, "Run04fSdlVideoOglCustomLinkedSide" },
	{ Run04gSdlEventStandalone, "Run04gSdlEventStandalone" },
};
