...
## Next
- Shift focus toward validating router-driven SDL/Eon workloads and documenting any remaining backend gaps (e.g., expand `upptst/Router` suites, wire diagnostics into IDE overlays, or confirm LV2/hardware synth hosts fully obey the credit helpers).
