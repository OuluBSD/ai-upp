...
struct McpLogEntry { Time ts; int level=1; int client_id=0; String req_id; String method; String message; int duration_ms=-1; };
...
public:
    ...
    int Size() const;
private:
    Vector<McpLogEntry> buf; int capacity = 1000; mutable RWMutex lock;
};
