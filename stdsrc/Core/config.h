...
// Copied from uppsrc/Core/config.h with minimal adjustments
// - Make <uppconfig.h> optional via __has_include
// - Keep macros and platform detection intact for source compatibility

#if defined(__has_include)
#  if __has_include(<uppconfig.h>)
#    include <uppconfig.h>
#  endif
#else
/* no __has_include; skip optional uppconfig.h */
#endif
...
#if defined(PLATFORM_POSIX) && defined(flagGUI)
