...
void ScrX11::SinkDevice_Visit(NativeSinkDevice& dev, AtomBase&, Visitor& vis) {
...
bool ScrX11::SinkDevice_NegotiateSinkFormat(NativeSinkDevice& dev, AtomBase&, LinkBase& link, int sink_ch, const ValueFormat& new_fmt) {
	TODO
	return false;
}
...
bool ScrX11::Context_Initialize(NativeContext& ctx, AtomBase& a, const Eon::WorldState& ws) {
	return true;
}
...
bool ScrX11::Context_NegotiateSinkFormat(NativeContext& ctx, AtomBase& a, LinkBase& link, int sink_ch, const ValueFormat& new_fmt) {
	return false;
}
