...
public:
	virtual void   RefreshLine(int i) override;
...
public:
	...
	virtual void   HorzMouseWheel(Point, int zdelta, dword) override;
	virtual Image  CursorImage(Point, dword) override;
	...
	virtual void   RefreshLine(int i) override;
	virtual Font   GetPreeditFont() override;
	virtual Rect   GetCaret() const override;

protected:
	virtual void    SetSb() override;
	virtual void    PlaceCaret(int64 newcursor, bool sel = false) override;
	virtual int     RemoveRectSelection() override;
	virtual WString CopyRectSelection() override;
	virtual int     PasteRectSelection(const WString& s) override;
...
protected:
	virtual void  HighlightLine(int line, Vector<Highlight>& h, int64 pos) override;
	virtual void  NewScrollPos() override;
...
public:
	...
	bool      IsShowReadOnly() const          { return showreadonly; }
...
public:
	...
	virtual void  LeftTriple(Point p, dword keyflags) override;
	virtual void  LeftUp(Point p, dword flags) override;
	virtual void  RightDown(Point p, dword w) override;
	virtual void  MouseMove(Point p, dword flags) override;
...
protected:
	...
	virtual void  InsertLines(int line, int count) override;
	virtual void  RemoveLines(int line, int count) override;
	virtual void  PlaceCaret(int64 pos, bool select = false) override;
	virtual void  InvalidateLine(int i) override;
