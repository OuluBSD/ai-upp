#ifndef _Eon_Generated_h_
#define _Eon_Generated_h_
...
#define ATOM_TYPE_LIST \
	...
	ATOM_TYPE(HANDLE_PROG_EVENTS) \
	ATOM_TYPE(CENTER_PROG_PIPE) \
	ATOM_TYPE(OGL_PROG_PIPE) \
	ATOM_TYPE(HANDLE_PROG_VIDEO) \
	...
	ATOM_TYPE(SDL_OGL_PROG_ATOM_PIPE) \
	...
	ATOM_TYPE(X11_OGL_EVENT_ATOM_PIPE) \
	ATOM_TYPE(WIN_CONTEXT_ATOM) \
	ATOM_TYPE(WIN_VIDEO_ATOM_PIPE) \
	ATOM_TYPE(DX_CUSTOMER) \
	ATOM_TYPE(WIN_D11_CONTEXT_ATOM) \
	ATOM_TYPE(WIN_D11_FBO_PROG) \
	ATOM_TYPE(WIN_D11_FBO_ATOM_PIPE) \
	ATOM_TYPE(WIN_D11_FBO_ATOM_SA) \
	...
	ATOM_TYPE(HOLO_CONTEXT_ATOM) \
	ATOM_TYPE(HOLO_EVENT_ATOM_PIPE) \
	ATOM_TYPE(HOLO_D12_FBO_ATOM_SA) \
	...
	ATOM_TYPE(SDL_UPP_OGL_DEVICE_SA) \
	ATOM_TYPE(SDL_OGL_FBO_PIPE) \
	ATOM_TYPE(SDL_OGL_FBO_ATOM) \
	ATOM_TYPE(SDL_UPP_EVENTS_BASE_PIPE) \
	ATOM_TYPE(SDL_VIDEO_ATOM_PIPE) \
	ATOM_TYPE(SDL_PROG_ATOM_PIPE) \
	ATOM_TYPE(X11_PROG_ATOM_PIPE) \
	ATOM_TYPE(X11_SW_FBO_GUI_PROG) \
	ATOM_TYPE(X11_OGL_FBO_GUI_PROG) \
	ATOM_TYPE(SDL_OGL_FBO_GUI_PROG) \
...
#define ATOM_CLASS_LIST \
	...
	ATOM_CLASS(HandleProgEvents) \
	ATOM_CLASS(CenterProgPipe) \
	ATOM_CLASS(OglProgPipe) \
	ATOM_CLASS(HandleProgVideo) \
	...
	ATOM_CLASS(X11OglEventAtomPipe) \
	ATOM_CLASS(WinContextAtom) \
	ATOM_CLASS(WinVideoAtomPipe) \
	ATOM_CLASS(DxCustomer) \
	ATOM_CLASS(WinD11ContextAtom) \
	ATOM_CLASS(WinD11FboProg) \
	ATOM_CLASS(WinD11FboAtomPipe) \
	ATOM_CLASS(WinD11FboAtomSA) \
	...
	ATOM_CLASS(HoloContextAtom) \
	ATOM_CLASS(HoloEventAtomPipe) \
	ATOM_CLASS(HoloD12FboAtomSA) \
	...
	ATOM_CLASS(SdlUppOglDeviceSA) \
	ATOM_CLASS(SdlOglFboPipe) \
	ATOM_CLASS(SdlOglFboAtom) \
	ATOM_CLASS(SdlUppEventsBasePipe) \
	ATOM_CLASS(SdlVideoAtomPipe) \
	ATOM_CLASS(SdlProgAtomPipe) \
	ATOM_CLASS(X11ProgAtomPipe) \
	ATOM_CLASS(X11SwFboGuiProg) \
	ATOM_CLASS(X11OglFboGuiProg) \
	ATOM_CLASS(SdlOglFboGuiProg) \
