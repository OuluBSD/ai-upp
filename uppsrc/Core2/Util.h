#ifndef _Core2_Util_h_
#define _Core2_Util_h_
...
template <class To, class From>	To ConvertFn(const From& from) {return from;}
template <> inline WString ConvertFn<WString,String>(const String& s) {return s.ToWString();}
template <> inline String ConvertFn<String,WString>(const WString& s) {return s.ToString();}
